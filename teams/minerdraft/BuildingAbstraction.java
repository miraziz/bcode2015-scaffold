...
abstract class BuildingAbstraction extends BaseBot {

	public BuildingAbstraction(RobotController myRc) throws GameActionException {
		super(myRc);
		transferSupplies();
	}
...
abstract class AttackingBuilding extends BuildingAbstraction {

	public AttackingBuilding(RobotController myRc) throws GameActionException {
		super(myRc);
		HashSet<MapLocation> visited = new HashSet<MapLocation>();
		int constant = 5;
		int farmScore = traverseFarm(rc.getLocation(), visited)
	...
	public void runBot() throws GameActionException {
		attack();
	}
...
abstract class ProductionBuilding extends BuildingAbstraction {

	public ProductionBuilding(RobotController myRc) throws GameActionException {
		super(myRc);
	}
}
