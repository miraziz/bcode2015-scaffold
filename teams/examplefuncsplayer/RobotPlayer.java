    ...
    public static void run(RobotController tomatojuice)
    {
        ...
        while (true)
        {
            ...
            if (rc.getType() == RobotType.BASHER)
            {
                try
                {
                    RobotInfo[] adjacentEnemies =
                        rc.senseNearbyRobots(2, enemyTeam);
...
// mostly randomly
            ...
            if (rc.getType() == RobotType.BARRACKS)
            {
                try
                {
                    ...
                    if (rc.isCoreReady()
                        && rc.getTeamOre() >= 60
                        && fate < Math.pow(1.2, 15 - numSoldiers - numBashers
                            + numBeavers) * 10000)
                    {
