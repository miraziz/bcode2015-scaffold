...
public class Channels
{
    ...
    static int              beaverTask1             = 50;   // channels 50-?
// are
// tasks
// needed
// to
// be done in order
    ...
    static int              buildPath               = 300;  // can span up to
// 30ish
// spots
    ...
    public static final int NUMBER_OF_MISSILES      = 2000;

    public static final int LOCATION_CHANNEL_OFFSET = 20000;
}
