...
public abstract class Proletariat extends Soveti {
	...
	/**
	 * moves towards the dest variable
	 * 
	 * returns true if a move made was made. returns false if no move call was
	 * made.
	 */
	public boolean bug() {
		if (dest == null) {
		...
		TerrainTile tileAhead = rc.senseTerrainTile(rc.getLocation()
				.add(facing));
